...
addpath(genpath('/data/disk2/luojunhao/test0918/code_Fibre_tri_inter_LR.v1.0.0//data/disk2/luojunhao/test0918/code_Fibre_tri_inter_LR.v1.0.0/fibre_tri_fun'))
...
%SubjectInfo.Subject_IDs='all';/data/disk2/xiongyirong/0825test
...
Result_Name='TEST_2MM_0927_tck2'
Logs_Folder='/data/disk2/luojunhao/test0918/log/log_2mm_0927_tck2'

%g_main_fibre2surfROI_CC_SGE_mat(Subject_path,Subject_IDs,Split_number,ROI_label1,ROI_label2,Surface_name1,Surface_name2,Label_name1,Label_name2,Track_type,track_label_name,threshold_distance,MyJob_Name,Logs_Folder,Result_Name)
...
%fibre_path='/data/disk2/luojunhao/test0918/subject/100307/track/100307_Terminate.txt';
% start_index=1;
% end_index=10000;
...
ROI_label1=1;
ROI_label2=1;
%Track_name='LJH_500000_Terminate'
